...
\begin{figure}
	\subfloat[][a]
	{\includegraphics[width = 0.5 \textwidth]{./Bilder/Compressor spool.png}}
	\caption{1}
	\subfloat[][b]
	{\includegraphics[width = 0.5 \textwidth]{./Bilder/Titan.jpg}}
	\caption{1}
	\subfloat[][c]
	{\includegraphics[width = 0.5 \textwidth]{./Bilder/Impeller.png}}
	\caption{1}
\end{figure}
