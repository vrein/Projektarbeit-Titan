...
\section{Herstellung von Titanlegierungen}
...
%Durch Zufügen einer beschränkten Menge von Legierungselementen kann es zu einer Erhöhung der Festigkeit durch Mischkristallverfestigung (solid solution strenghtening) führen. Werden Legierungselemente hinzugefügt, die nicht lösbar sind, formen diese zweite Phasen (intermetallic compounds), welche die Deformation einschränken und dadurch auch die Festigkeit erhöhen.
...
\section{Verwendung von Titan und Titanlegierungen 	}
